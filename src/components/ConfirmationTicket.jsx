        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 336 101.93" className="confirmationTicket">
            ...
            <g id="Layer_1-2" data-name="Layer 1">
                ...
                <text className="cls-15" transform="translate(12 45)">
                    <tspan className="cls-10" x="30" textAnchor="middle">{ticketDetails.ticketType}</tspan>
                    <tspan className="cls-18" x="30" y="17" textAnchor="middle">{calculatePrice(ticketDetails.ticketType, showDetails.movieId.price)}</tspan>
                </text>
